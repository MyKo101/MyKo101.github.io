...
\experience{Data Analyst \& Scientist}{EvoSoft}{Nov 2022}{Present}{
    \begin{explist}
        \item Constructed Data Pipelines using AWS Lambda, S3 and Athena
        \item Built Cloud Infrastructure using AWS Cloudformation
        \item Created APIs to channel data to PowerBI under a servless framework
        \item Designed an AWS Amplify Dashboard using React.ts for direct data access
        \item Developed several statistical \& business models for customer classification
    \end{explist}
}

\experience{Compliance Manager}{The Very Group}{Feb 2022}{Nov 2022}{
    \begin{explist}
