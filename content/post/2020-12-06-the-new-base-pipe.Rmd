...
```
Clearly, the lambda version of the base packages needs more time, again because it is creating the function in the middle, whereas the named version does not have to do this. Why? Again, let's capture them:
